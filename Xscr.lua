...
gg.getResults(5000) 
gg.editAll('999', gg.TYPE_FLOAT) gg.toast('Loading Kutukan Putih')
...
if HA3[5] == true then Fir() end
if HA3[6] == true then Sco() end
if HA3[7] == true then Ailo() end
if HA3[8] == true then Sits() end
if HA3[9] == true then Lifs() end
if HA3[10] == true then HOME() end
end
HambaAllah = -1
end
...
WH = gg.multiChoice({
  ...
  "🔘Wallhack - HDR",
  "🏠Home"},nil,"PUBG MOBILE 0.7.5 FREE v2.0\n🅾️NO CHEAT NO WIN xD")
  if WH[1] == true then Whhen() end
  if WH[2] == true then Whp() end
  if WH[3] == true then Whs42() end
  if WH[4] == true then Whs43() end
  if WH[5] == true then Whs62() end
  if WH[6] == true then Whs66() end
  if WH[7] == true then Whs8x() end
  if WH[8] == true then Whuni() end
  if WH[9] == true then Whhdr() end
  if WH[10] == true then HOME() end
HambaAllah=-1
end

function Whhdr() -- Wallhack HDR
...
function Whuni() -- Wallhack All SD
  gg.setRanges(gg.REGION_BAD)
  gg.clearResults()
  gg.searchNumber("2.25000190735;3.75055122375;2::", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
  gg.searchNumber("2", gg.TYPE_FLOAT, false, gg.SIGN_EQUAL, 0, -1)
...
function Whs8x() -- Wallhack SD 8xx
  gg.clearResults()
  gg.setRanges(gg.REGION_BAD)
...
function Whs66() -- Wallhack SD 660
gg.clearResults()
gg.setRanges(gg.REGION_BAD)
...
function Whs43() -- Wallhack SD 430
gg.clearResults()
gg.setRanges(gg.REGION_BAD)
...
function Whs62() -- Wallhack SD 625
gg.clearResults()
gg.setRanges (gg.REGION_BAD)
...
function Whhen() -- Wallhack Mediatek
gg.clearResults()
gg.setRanges(gg.REGION_BAD)
...
Hs = gg.choice({
  ...
  if Hs == 2 then Hsh() end
  if Hs == 3 then HOME() end
  HambaAllah=-1
  end
...
An = gg.choice({
  ...
  "🎐Antena Back",
  "🏠Home"},nil,"PUBG MOBILE 0.7.5 FREE v2.0\n🅾️NO CHEAT NO WIN xD")
  if An == 1 then ARun() end
  if An == 2 then AAlw() end
  if An == 3 then AHea() end
  if An == 4 then ABac() end
  if An == 5 then HOME() end
  HambaAllah=-1
  end
...
Fr = gg.multiChoice({
  ...
  if Fr[6] == true then M24() end
  if Fr[7] == true then a98K() end
  if Fr[8] == true then VSS() end
  if Fr[9] == true then ASMG() end
  if Fr[10] == true then HOME() end
  HambaAllah=-1
  end
...
of = gg.multiChoice({
  ...
  "🏃Speed Hack",
  "🏃Speed Hack low",
  "🏃Less Gravity (Careful)",
  "🏟️Big Helmet",
  "🎭Small Character",
  "🎭Big Character",
  "🏠Home"},nil,"PUBG MOBILE 0.7.5 FREE v2.0\n🅾️NO CHEAT NO WIN xD")  
  if of[1] == true then Wsh() end
  if of[2] == true then Ngr() end
  if of[3] == true then Ngrt() end
  if of[4] == true then Bls() end
  if of[5] == true then Bll() end
  if of[6] == true then Snl() end
  if of[7] == true then Jsp() end
  if of[8] == true then Jwt() end
  if of[9] == true then Jcl() end
  if of[10] == true then Sph() end
  if of[11] == true then Sphl() end
  if of[12] == true then Lgv() end
  if of[13] == true then Bhel() end
  if of[14] == true then Scha() end
  if of[15] == true then Bcha() end
  if of[16] == true then HOME() end
  HambaAllah=-1
  end
